...
FactoryBot.define do
  ...
  factory :project, class: 'Project' do
    ...
    transient do
      ...
      merge_before_pipeline_completes_enabled { nil }
    end
    ...
    after(:create) do |project, evaluator|
      ...
      project.merge_before_pipeline_completes_enabled = evaluator.merge_before_pipeline_completes_enabled unless evaluator.merge_before_pipeline_completes_enabled.nil?
