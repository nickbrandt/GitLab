...
RSpec.describe AuthorizedProjectUpdate::ProjectCreateService do
  ...
  describe '#perform' do
    ...
    context 'membership overrides' do
      ...
      context 'group sharing' do
        ...
        before do
          ...
          create(:group_member, access_level: Gitlab::Access::LIMITED_ACCESS, group: shared_with_group, user: create(:user))
    ...
    context 'member with limited access' do
      before do
        create(:group_member, access_level: Gitlab::Access::LIMITED_ACCESS, user: group_user, group: group)
      end
