...
require Rails.root.join('db', 'post_migrate', '20210611142016_timing_test_of_schedule_backfill_draft_column_on_merge_requests.rb')

RSpec.describe TimingTestOfScheduleBackfillDraftColumnOnMergeRequests, :migration do
