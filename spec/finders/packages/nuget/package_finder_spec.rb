  ...
  describe '#execute!' do
    ...
    context 'with a subgroup' do
      ...
      context 'with a group deploy token' do
        let_it_be(:deploy_token) { create(:deploy_token, read_package_registry: true, write_package_registry: true, deploy_token_type: :group_type) }
        let_it_be(:group_deploy_token) { create(:group_deploy_token, deploy_token: deploy_token, group: subgroup) }

        let(:user) { group_deploy_token.deploy_token }
