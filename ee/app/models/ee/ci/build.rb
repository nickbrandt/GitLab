...
module EE
  module Ci
    ...
    module Build
      ...
      def collect_dependencies_list_report
        each_report(::Ci::JobArtifact::DEPENDENCIES_LIST_REPORT_FILE_TYPES) do |file_type, blob|
          ...
          ::Gitlab::Ci::Parsers::DependenciesList.parse(blob, commit_path)
        end
