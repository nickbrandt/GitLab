...
module EE
  module MergeRequest
    ...
    def compare_container_scanning_reports
      ...
      head_report = actual_head_pipeline&.security_reports.get_report('container_scanning')
      base_report = base_pipeline&.security_reports.get_report('container_scanning')

      Security::CompareReportsContainerScanningService.new(head_report, base_report, Vulnerabilities::OccurrenceDiffSerializer).execute
    end
