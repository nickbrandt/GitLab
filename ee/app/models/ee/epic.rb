...
module EE
  module Epic
    ...
    def validate_parent(preloaded_parent_group_and_descendants = nil)
      ...
      if self == parent
        errors.add :parent, 'Sorry, this epic cannot be added. An epic cannot be added to itself.'
      elsif parent.children.to_a.include?(self)
        errors.add :parent, "Sorry, this epic cannot be added. It is already assigned to the parent epic."
      elsif parent.has_ancestor?(self)
        errors.add :parent, "Sorry, this epic cannot be added. This epic is already an ancestor of the parent epic."
      elsif !preloaded_parent_group_and_descendants.include?(group)
        errors.add :parent, "Sorry, this epic cannot be added. An epic must belong to the same group, or subgroup, of its parent epic."
      elsif level_depth_exceeded?(parent)
        errors.add :parent, "Sorry, this epic cannot be added. An epic cannot have more than #{MAX_HIERARCHY_DEPTH} ancestors."
      end
    end
