...
module EE
  module SystemNotes
    class MergeTrainService < ::SystemNotes::BaseService
      ...
      def add_to_merge_train_when_pipeline_succeeds(sha)
      ...
      def cancel_add_to_merge_train_when_pipeline_succeeds
      ...
      def abort_add_to_merge_train_when_pipeline_succeeds(reason)
