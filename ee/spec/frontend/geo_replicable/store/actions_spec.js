  ...
  describe('fetchReplicableItems', () => {
    ...
    describe('queryParams', () => {
      ...
      describe('no params set', () => {
        it('should call fetchReplicableItems with default queryParams and correct replicable param', () => {
      ...
      describe('with params set', () => {
        it('should call fetchReplicableItems with queryParams and correct replicable param', () => {
          state.isLoading = true;
          state.currentPage = 3;
