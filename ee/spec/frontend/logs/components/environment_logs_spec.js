...
describe('EnvironmentLogs', () => {
  ...
  const mockShowPodLogs = () => {
    ...
    state.logs.pageInfo.totalResults = mockLogsResult.length;
  };
  ...
  describe('state with data', () => {
    ...
    it('shows infinite scroll with height and no content', () => {
      ...
      // TODO Add total when implemented
      // expect(getInfiniteScrollAttr('total-items')).toBe(mockTrace.length);
    });
    ...
    it('populates footer', () => {
      ...
      expect(footer).toContain(`${mockLogsResult.length} out of ${mockLogsResult.length}`);
    });
  ...
  describe('listeners', () => {
    ...
    it('`scroll` results in enabled scroll buttons', () => {
    ...
    it('`scroll` results in disabled scroll buttons', () => {
