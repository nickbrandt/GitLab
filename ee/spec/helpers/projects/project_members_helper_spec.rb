  ...
  describe '#project_members_data_json' do
    ...
    it 'does not execute N+1' do
      control_count = ActiveRecord::QueryRecorder.new do
        helper.project_members_list_data_json(project, preloaded_members)
      end.count
      ...
      expect { helper.project_members_list_data_json(project, preloaded_members) }.not_to exceed_query_limit(control_count).with_threshold(6) # existing n+1
    end
  end
