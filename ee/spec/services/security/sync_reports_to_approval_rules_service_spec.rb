  ...
  context 'when there are reports' do
    context 'when pipeline passes' do
      ...
      context "license compliance policy" do
        let!(:software_license_policy) { create(:software_license_policy, :denied, project: project, software_license: blocked_license) }
        ...
        let!(:blocked_license) { create(:software_license) }

        context "when a license violates the license compliance policy" do
          let!(:blocked_license) { create(:software_license, name: license_name) }
