...
FactoryBot.define do
  factory :ee_ci_build, class: 'Ci::Build', parent: :ci_build do
    ...
    %i[codequality container_scanning dast dependency_scanning license_management license_scanning performance browser_performance load_performance coverage_fuzzing].each do |report_type|
