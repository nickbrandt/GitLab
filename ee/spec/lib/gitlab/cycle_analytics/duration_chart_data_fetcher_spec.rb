...
describe Gitlab::CycleAnalytics::DurationChartDataFetcher do
  context 'provides chart data' do
    ...
    it 'for issues stage' do
      ...
      stage = Gitlab::CycleAnalytics::IssueStage.new(options: {
        from: 2.days.ago,
        current_user: user,
        group: group
      })
    ...
    it 'for staging stage' do
      ...
      stage = Gitlab::CycleAnalytics::StagingStage.new(options: {
        from: 2.days.ago,
        current_user: user,
        group: group
      })
