...
describe Project do
  ...
  describe '#visible_user_defined_non_applicable_rules' do
    let(:project) { create(:project) }
      ...
      context 'when target_branch is specified' do
        ...
        context 'when rules are scoped' do
          ...
          it 'returns rules that are not applicable to target_branch' do
            expect(project.visible_user_defined_non_applicable_rules(target_branch: 'stable-1'))
        ...
        context 'when rules are not scoped' do
          it 'returns empty array' do
            expect(project.visible_user_defined_non_applicable_rules).to be_empty
          end
        end
      end

      context 'when no target_branch is specified' do
        it 'returns empty array' do
          expect(project.visible_user_defined_non_applicable_rules).to be_empty
        end
      end
    ...
    context 'when multiple approval rules is not available' do
      ...
      it 'returns empty array' do
        expect(project.visible_user_defined_non_applicable_rules(target_branch: 'stable-1')).to be_empty
      end
    end
  end
