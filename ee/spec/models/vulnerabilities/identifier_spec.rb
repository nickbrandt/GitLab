...
describe Vulnerabilities::Identifier do
  describe 'associations' do
    ...
    it { is_expected.to have_many(:occurrences).class_name('Vulnerabilities::Finding') }
    it { is_expected.to have_many(:primary_occurrences).class_name('Vulnerabilities::Finding') }
