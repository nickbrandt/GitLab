...
RSpec.describe Vulnerabilities::Finding::Evidence do
  ...
  it { is_expected.to have_one(:asset).class_name('Vulnerabilities::Finding::Evidence::Asset').with_foreign_key('vulnerability_finding_evidence_id').inverse_of(:evidence) }
