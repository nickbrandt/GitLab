...
describe Ci::Pipeline do
  ...
  describe '#license_scanning_reports' do
    ...
    context 'when pipeline has multiple builds with license management reports' do
      ...
      before do
        create(:ee_ci_job_artifact, :license_scanning, job: build_1, project: project)
        create(:ee_ci_job_artifact, :license_scanning_feature_branch, job: build_2, project: project)
      end
  ...
  describe '#dependency_list_reports' do
    ...
    context 'when pipeline has a build with dependency list reports' do
      ...
      let!(:artifact2) { create(:ee_ci_job_artifact, :license_scanning, job: build, project: project) }
