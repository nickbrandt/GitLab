...
RSpec.describe 'layouts/header/_new_dropdown' do
  ...
  context 'refactor pin' do
    ...
    def clean_str(str)
      str.strip.gsub(/[\r\n]{2,}/, "\n").gsub(%r{assets/icons-\w+\.svg}, "assets/icons.svg")
    end
    ...
    before do
      ...
      allow(view).to receive(:content_for).and_return('New project')
...
<a class="header-new-dropdown-toggle has-tooltip" id="js-onboarding-new-project-link" title="New..." ref="tooltip" aria-label="New..." data-toggle="dropdown" data-placement="bottom" data-container="body" data-display="static" data-qa-selector="new_menu_toggle" href="/projects/new"><svg class="s16" data-testid="plus-square-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#plus-square"></use></svg>
...
<li><a data-track-event="click_link_new_issue" data-track-label="plus_menu_dropdown" data-qa-selector="new_issue_link" href="/namespace1/project1/-/issues/new">New issue</a></li>
