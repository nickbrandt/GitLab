...
module Gitlab
  module PathRegex
    ...
    def repository_route_regex
      @repository_route_regex ||= %r{#{full_namespace_route_regex}|#{personal_snippet_repository_path_regex}}.freeze
    end

    def repository_git_route_regex
      @repository_git_route_regex ||= %r{#{repository_route_regex}\.git}.freeze
    end

    def repository_wiki_git_route_regex
      @wiki_repository_route_regex ||= /#{full_namespace_route_regex}\.wiki\.git/.freeze
    end
