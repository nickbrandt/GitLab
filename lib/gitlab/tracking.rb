  ...
  module Tracking
    ...
    class << self
      ...
      def event(category, action, label: nil, property: nil, value: nil, context: nil)
        ...
        snowplow.track_struct_event(category, action, label, property, value, context, (Time.current.to_f * 1000).to_i)
      end
      ...
      def self_describing_event(schema_url, event_data_json, context: nil)
        ...
        snowplow.track_self_describing_event(event_json, context, (Time.current.to_f * 1000).to_i)
      end
