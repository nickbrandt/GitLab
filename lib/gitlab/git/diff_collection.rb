  ...
  module Git
    class DiffCollection
      ...
      def self.diff_safe_max_files(project: nil)
        ::Commit.diff_max_files(project: project) / 10
      end

      def self.diff_safe_max_lines(project: nil)
        ::Commit.diff_max_lines(project: project) / 10
      end

      def self.default_limits(project: nil)
        { max_files: diff_safe_max_files(project: project), max_lines: diff_safe_max_lines(project: project) }
      end
