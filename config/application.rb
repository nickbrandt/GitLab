...
module Gitlab
  class Application < Rails::Application
    ...
    config.assets.precompile << "page_bundles/projects_common.css"
    config.assets.precompile << "page_bundles/projects_edit_new.css"
    config.assets.precompile << "page_bundles/projects_forks.css"
    config.assets.precompile << "page_bundles/projects_import.css"
    config.assets.precompile << "page_bundles/projects_list.css"
    config.assets.precompile << "page_bundles/projects_show.css"
    config.assets.precompile << "page_bundles/projects_settings.css"
