...
Gitlab.ee do
  ...
  Settings.cron_jobs['deleting_marked_projects_destroy_cron_worker'] ||= Settingslogic.new({})
  Settings.cron_jobs['deleting_marked_projects_destroy_cron_worker']['cron'] ||= '0 4 * * *'
  Settings.cron_jobs['deleting_marked_projects_destroy_cron_worker']['job_class'] = 'DeletingMarkedProjectsDestroyCronWorker'
