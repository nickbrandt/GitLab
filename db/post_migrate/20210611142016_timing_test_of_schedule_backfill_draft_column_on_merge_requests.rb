...
class TimingTestOfScheduleBackfillDraftColumnOnMergeRequests < ActiveRecord::Migration[6.0]
  ...
  def up
    ...
    update_column_in_batches(:merge_requests, :draft, true, batch_size: 10) do |table, query|
      query
