...
ActiveRecord::Schema.define(version: 20180709184533) do
  ...
  add_foreign_key "protected_environment_deploy_access_levels", "namespaces", column: "group_id", name: "fk_45cc02a931", on_delete: :cascade
