...
ActiveRecord::Schema.define(version: 20180704204006) do
  ...
  add_index "protected_environment_deploy_access_levels", ["protected_environment_id", "group_id"], name: "pro_env_dep_acc_lev_project_id_group_id", unique: true, using: :btree
  add_index "protected_environment_deploy_access_levels", ["protected_environment_id", "user_id"], name: "pro_env_dep_acc_lev_project_id_user_id", unique: true, using: :btree
  ...
  add_foreign_key "protected_environment_deploy_access_levels", "protected_environments"
  add_foreign_key "protected_environment_deploy_access_levels", "users"
  add_foreign_key "protected_environments", "projects"
