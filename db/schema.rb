...
ActiveRecord::Schema.define(version: 2019_10_16_072826) do
  ...
  create_table "application_settings", id: :serial, force: :cascade do |t|
    ...
    t.integer "project_deletion_adjourned_period", default: 7, null: false
  ...
  create_table "projects", id: :serial, force: :cascade do |t|
    ...
    t.index ["marked_for_deletion_by_id"], name: "index_projects_on_marked_for_deletion_by_id", where: "(marked_for_deletion_by_id IS NOT NULL)"
