...
- [ ] If it is possible to perform an incremental rollout, this should be preferred. Proposed increments are: `5%`, `15%`, `25%`, `50%`, `75%`, `100%`. Proposed minimum time between increments is 15 minutes.
