...
| Feature                                                              | Replicated (added in GitLab version)                                              | Verified                                                | Notes                                                                                                      |
|:---------------------------------------------------------------------|:---------------------------------------------------------|:--------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------|
...
| CI job artifacts (other than traces)                                 | **Yes** (10.2)                                                  | [No](https://gitlab.com/gitlab-org/gitlab/-/issues/8923)  | Verified only manually (*1*)                                                                               |
...
| [NPM Registry](../../../user/packages/npm_registry/index.md)         | **Yes** (13.1)                                                 | No                                                      |                                                                                                            |
| [Maven Repository](../../../user/packages/maven_repository/index.md) | **Yes** (13.1)                                                 | No                                                      |                                                                                                            |
| [Conan Repository](../../../user/packages/conan_repository/index.md) | **Yes** (13.1)                                                 | No                                                      |                                                                                                            |
| [NuGet Repository](../../../user/packages/nuget_repository/index.md) | **Yes** (13.1)                                                 | No                                                      |                                                                                                            |
| [PyPi Repository](../../../user/packages/pypi_repository/index.md)   | **Yes** (13.1)                                                 | No                                                      |                                                                                                            |
| [Composer Repository](../../../user/packages/composer_repository/index.md) | **Yes** (13.1)                                             | No                                                      |                                                                                                            |
