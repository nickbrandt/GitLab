...
## List a group's ancestor groups

> [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/217115) in GitLab 13.6

Get a list of visible ancestor groups of this group.
When accessed without authentication, only public groups are returned.
...
[
  {
    ...
    "name": "Bar Group",
    "path": "bar",
    "description": "An ancestor group of Foo Group",
    "visibility": "public",
    "share_with_group_lock": false,
    "require_two_factor_authentication": false,
    "two_factor_grace_period": 48,
    ...
    "default_branch_protection": 2,
    "avatar_url": "http://gitlab.example.com/uploads/group/avatar/1/bar.jpg",
    "web_url": "http://gitlab.example.com/groups/bar",
    "request_access_enabled": false,
    "full_name": "Bar Group",
    "full_path": "bar",
    "file_template_project_id": 1,
