...
Replaces the link to the internal wiki with a link to a Confluence Cloud wiki.
...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `confluence_url` | string | true | The URL of the Confluence Cloud Wiki hosted on atlassian.net.  |
