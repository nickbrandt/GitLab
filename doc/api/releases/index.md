...
| `milestones`       | array of string | no                          | The title of each milestone the release is associated with. For premium customers, group milestones can be specified.                                                                      |
...
| `name`        | string          | no       | The release name.                                                                                           |
| `description` | string          | no       | The description of the release. You can use [Markdown](../../user/markdown.md).                             |
| `milestones`  | array of string | no       | The title of each milestone to associate with the release. For premium customers, group milestones can be specified. (Specify `[]` to remove all milestones from the release). |
