...
| `vulnerabilityGrades` | VulnerabilityGrades! | Represents vulnerable project counts for each grade |
...
Represents vulnerability letter grades

| Name  | Type  | Description |
| ---   |  ---- | ----------  |
| `a` | VulnerabilityLetterGrade! | Projects with no vulnerabilities and security scanning enabled |
| `b` | VulnerabilityLetterGrade! | Vulnerable projects with low severities |
| `c` | VulnerabilityLetterGrade! | Vulnerable projects with medium severities |
| `d` | VulnerabilityLetterGrade! | Vulnerable projects with high or unknown severities |
| `f` | VulnerabilityLetterGrade! | Vulnerable projects with critical severities |
...
## VulnerabilityLetterGrade

Represents vulnerable projects and count for the letter grade

| Name  | Type  | Description |
| ---   |  ---- | ----------  |
| `count` | Int! | Number of vulnerable projects in this vulnerability letter grade |
