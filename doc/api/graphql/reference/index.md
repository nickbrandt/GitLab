...
| `clientMutationId` | String | A unique identifier for the client performing the mutation. |
| `errors` | String! => Array | Errors encountered during execution of the mutation. |
| `needsRecaptcha` | Boolean | Indicates whether a valid gRecaptchaResponse response to a reCAPTCHA challenge must be included in the request in order for the operation to be completed |
