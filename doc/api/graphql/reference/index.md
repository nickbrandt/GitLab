...
### VulnerabilityCreateMergeRequestFeedbackPayload

Autogenerated return type of VulnerabilityCreateMergeRequestFeedback.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `clientMutationId` | String | A unique identifier for the client performing the mutation. |
| `errors` | String! => Array | Errors encountered during execution of the mutation. |
| `mergeRequestFeedback` | VulnerabilityMergeRequestFeedback | The feedback from the created merge request |
...
### VulnerabilityMergeRequestFeedback

Represents feedback created from a vulnerability.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `author` | User! | Feedback author |
| `branch` | String! | Project fingerprint for project where vulnerability is found |
| `category` | VulnerabilityReportType! | Category of the vulnerability |
| `createdAt` | Time! | Feedback creation timestamp |
| `feedbackType` | String! | The type of feedback |
| `id` | ID! | GraphQL ID of the vulnerability |
| `mergeRequestIid` | Int | The id of the merge request created for the vulnerability |
| `mergeRequestPath` | String | The path of the merge request created for the vulnerability |
| `projectId` | Int! | Project ID of the vulnerability |
