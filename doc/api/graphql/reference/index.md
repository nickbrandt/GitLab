...
| ---   |  ---- | ----------  |
| `clientMutationId` | String | A unique identifier for the client performing the mutation. |
| `errorMessages` | String! => Array | Errors encountered during execution of the mutation. |
| `errors` | Error! => Array | Enhanced errors encountered during execution of the mutation. |
...
| Name  | Type  | Description |
| ---   |  ---- | ----------  |
| `extensions` | ErrorExtensions! | Error Extensions |
| `message` | String! | Error Message |
| `path` | String! => Array | Error Path |
