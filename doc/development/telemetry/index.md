...
These are settings of your instance such as the instance's git version, postgres version, or if certain features are enabled such as container_registry_enabled or signup_enabled.
