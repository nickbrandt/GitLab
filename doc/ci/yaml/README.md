...
> - [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/294232) in GitLab 13.8.
...
You can use [`variables`](#variables) in `workflow:rules:` to define variables for specific conditions.
