...
Two-factor Authentication (2FA) provides an additional level of security to your GitLab account. Once enabled, in addition to supplying your username and password to login, you'll be prompted for a code generated by your time-based one time password authenticator. For example, a password manager on one of your devices. By enabling 2FA, the only way someone other than you can log into your account is to know your username and password *and* have access to your one time password secret.
...
There are two ways to enable two-factor authentication: via a time-based one time password (TOTP) authenticator
app or a U2F device.

### Using a time-based one time password authenticator
...
of [recovery codes](#obtaining-recovery-codes). Make sure you download them and keep them
in a safe place.
...
When asked, enter the pin from your time-based one time password authenticator's application or a recovery code to log in.
...
to your time-based one time password authenticator, you can use one of them to log in to
...
If you have lost your code generation device and need to disable two-factor authentication in order to regain access to your account you can:
...
If you are a GitLab.com user you will need to [contact GitLab Support](https://support.gitlab.com/hc/en-us/requests/new).
