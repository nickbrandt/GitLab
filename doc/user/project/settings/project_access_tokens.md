...
You may enable or disable project access tokens for all projects in a group in **Group > Settings > General > Permissions, LFS, 2FA > Project access tokens enabled**.
