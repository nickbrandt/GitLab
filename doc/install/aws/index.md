...
## Finding Official GitLab Created AMI IDs on AWS

Here is how you find AMIs generated by GitLab.

1. Login to AWS Console

2. Pick your desired option below:

    * [Enterprise Edition](https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#Images:visibility=public-images;ownerAlias=782774275127;search=GitLab%20EE;sort=desc:name) (Add A License Key)
    * [Community Edition](https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#Images:visibility=public-images;ownerAlias=782774275127;search=GitLab%20CE;sort=desc:name)
    * [MarketPlace Premium or Ultimate](https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#Images:visibility=public-images;source=Marketplace;search=GitLab%20EE;sort=desc:name) (5 User License Built Into Per-Minute Billing)

3. AMI IDs are unique per region - so once you've loaded one of the above, click the region selector to find the AMI ID for that region.

Once loaded, you can add additional search criteria to narrow further.  For instance, “13.” to find only 13.x versions.

**Note**: [Click Here for Enterprise and Community Edition Before 11.10.3](https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#Images:visibility=public-images;ownerAlias=855262394183;sort=desc:name) (May be needed for first stage of lift and shift migration)
