...
1. Pick your desired option below:
...
1. AMI IDs are unique per region - so once you've loaded one of the above, click the region selector to find the AMI ID for that region.
