...
WARNING:
This guide is deprecated and pending an update. For the time being, you can use
GitLab's [new image in the Azure Marketplace](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/gitlabinc1586447921813.gitlabee?tab=Overview).
