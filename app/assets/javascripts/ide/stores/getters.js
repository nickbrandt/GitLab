...
import { leftSidebarViews, packageJsonPath } from '../constants';
...
export const isEditModeActive = state =>
  state.leftPane.currentView === leftSidebarViews.ideTree.name;
export const isCommitModeActive = state =>
  state.leftPane.currentView === leftSidebarViews.commit.name;
export const isReviewModeActive = state =>
  state.leftPane.currentView === leftSidebarViews.review.name;
