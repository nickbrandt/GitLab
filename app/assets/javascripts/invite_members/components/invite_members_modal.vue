  ...
  labels: {
    members: {
      ...
      toGroup: {
        ...
        restrictedMessage: s__(
          'InviteMembersModal|The domain for %{email} is not allowed for this group.',
        ),
        restrictedMessage2: s__(
          'InviteMembersModal|Go to the group’s Settings &gt; General page, and check the permissions.',
        ),
      },
      toProject: {
        introText: s__(
        ...
        restrictedMessage: s__(
          'InviteMembersModal|The domain for %{email} is not allowed for this project.',
        ),
      },
    },
    group: {
