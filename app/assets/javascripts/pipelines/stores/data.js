export default {
  ...
  user: {
    ...
    status_tooltip_html:
      '<span class="user-status-emoji has-tooltip" title="" data-html="true" data-placement="top"><gl-emoji title="trumpet" data-name="trumpet" data-unicode-version="6.0">🎺</gl-emoji></span>',
    path: '/axil',
  },
  active: false,
  coverage: null,
  ...
  commit: {
    ...
    author: {
      ...
      state: 'active',
      avatar_url:
        'https://assets.gitlab-static.net/uploads/-/system/user/avatar/3585/avatar.png',
      web_url: 'https://gitlab.com/axil',
  ...
  triggered: [
    ...
    },
    {
      ...
      coverage: null,
      source: 'pipeline',
      path: '/gitlab-com/gitlab-docs/pipelines/34993052',
      details: {
        status: {
          icon: 'status_failed',
          text: 'failed',
