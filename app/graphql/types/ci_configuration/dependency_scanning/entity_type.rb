  ...
  module CiConfiguration
    module DependencyScanning
      ...
      class EntityType < BaseObject
        graphql_name 'DependencyScanningCiConfigurationEntity'
        ...
        field :options, ::Types::CiConfiguration::DependencyScanning::OptionsEntityType.connection_type, null: true,
        ...
        field :size, ::Types::CiConfiguration::DependencyScanning::UiComponentSizeEnum, null: true,
