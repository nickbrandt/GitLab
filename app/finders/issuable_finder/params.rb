...
class IssuableFinder
  class Params < SimpleDelegator
    ...
    def milestones?
      params[:milestone_title].present? || params[:milestone_timebox].present?
    end
    ...
    def filter_by_no_milestone?
      ...
      params[:milestone_title].to_s.downcase == FILTER_NONE ||
        ...
        params[:milestone_timebox].to_s.downcase == FILTER_NONE
    end
    ...
    def filter_by_any_milestone?
      ...
      params[:milestone_title].to_s.downcase == FILTER_ANY ||
        ...
        params[:milestone_timebox].to_s.downcase == FILTER_ANY
    end

    def filter_by_upcoming_milestone?
      # Usage of `#upcoming` in milestone_title to be deprecated
      # https://gitlab.com/gitlab-org/gitlab/-/issues/336044
      params[:milestone_title] == Milestone::Upcoming.name || params[:milestone_timebox].to_s.downcase == FILTER_UPCOMING
    end

    def filter_by_started_milestone?
      # Usage of `#started` in milestone_title to be deprecated
      # https://gitlab.com/gitlab-org/gitlab/-/issues/336044
      params[:milestone_title] == Milestone::Started.name || params[:milestone_timebox].to_s.downcase == FILTER_STARTED
    end
