...
class Environment < ApplicationRecord
  ...
  has_many :deployments, -> { success }, inverse_of: :environment, dependent: :destroy # rubocop:disable Cop/ActiveRecordDependent

  has_one :last_deployment, -> { success.order('deployments.id DESC') }, inverse_of: :environment, class_name: 'Deployment'
