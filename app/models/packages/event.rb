...
class Packages::Event < ApplicationRecord
  ...
  belongs_to :container_repository, optional: true
  ...
  enum event_type: {
    ...
    list_tags: 9,
    cli_metadata: 10,
    expiration_policy_started: 11,
    expiration_policy_ended: 12,
    expiration_policy_stopped: 13
  }

  enum originator_type: { user: 0, deploy_token: 1, guest: 2, worker: 3 }
