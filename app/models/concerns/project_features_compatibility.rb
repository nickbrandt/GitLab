...
module ProjectFeaturesCompatibility
  ...
  # TODO: Remove this after we remove the projects.container_registry_enabled column
  # and we drop support for project create/edit APIs to set the
  # container_registry_enabled column. They can instead set the container_registry_access_level
  # column.
