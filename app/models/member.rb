...
class Member < ApplicationRecord
  ...
  validate :invite_email_not_restricted_for_signup, on: :create
  validates :user_id,
    uniqueness: {
  ...
  def invite_email_not_restricted_for_signup
    valid = signup_domain_valid_for?(invite_email)
    errors.add(:user, error_for_signup(invite_email)) unless valid

    restricted = email_restrictions_for?(invite_email)
    errors.add(:user, error_for_restriction(invite_email)) if restricted
  end
