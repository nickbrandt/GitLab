...
class User < ApplicationRecord
  ...
  # Groups
  has_many :members
  has_many :group_members, -> { where(requested_at: nil).where.not(access_level: [Gitlab::Access::LIMITED_ACCESS]) }, source: 'GroupMember'
  ...
  has_many :reporter_developer_maintainer_owned_groups,
           ...
           through: :group_members,
           source: :group
  has_many :limited_access_group_members, -> { where(access_level: [Gitlab::Access::LIMITED_ACCESS]) }, source: 'GroupMember', class_name: 'GroupMember'
  has_many :limited_access_groups, through: :limited_access_group_members, source: :group
