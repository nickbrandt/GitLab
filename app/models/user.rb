...
class User < ApplicationRecord
  ...
  with_options to: :user_preference do
    delegate :notes_filter_for
    delegate :set_notes_filter
    delegate :first_day_of_week, :first_day_of_week=
    delegate :timezone, :timezone=
    delegate :time_display_relative, :time_display_relative=
    delegate :time_format_in_24h, :time_format_in_24h=
    delegate :show_whitespace_in_diffs, :show_whitespace_in_diffs=
    delegate :tab_width, :tab_width=
    delegate :sourcegraph_enabled, :sourcegraph_enabled=
    delegate :setup_for_company, :setup_for_company=
    delegate :render_whitespace_in_code, :render_whitespace_in_code=
  end
